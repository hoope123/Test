...
//PRINCE-MDX~A0QSkFmSyR4iHnf53yAH

global.sessionServer = "https://session-id-backend.zone.id";
global.session = "https://session-id-2fza.onrender.com"; 
 
 
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~hETMsPVK7nwRBa4NzqcM", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "i am prince mdx",
