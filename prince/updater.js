  ...
  if (!isSuperUser) {
    ...
    try {
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your PRINCE-MDX Bot is Already on the Latest Version!");
        }
        ...
        await reply(`🔄 Updating PRINCE-MDX Bot...\n\n*Commit Details:*\n👤 Author: ${authorName} (${authorEmail})\n📅 Date: ${commitDate}\n💬 Message: ${commitMessage}`);

        const zipPath = path.join(__dirname, '..', 'prince-md-main.zip');
