...
const { sendButtons } = require('prince-btns');
const { downloadContentFromMessage, generateWAMessageFromContent, normalizeMessageContent } = require('prince-baileys');
...
async function handleUpload(from, Prince, conText, service) {
    const { mek, reply, react, botFooter, botPrefix, quoted, getMediaBuffer, uploadToPrinceCdn, uploadToGithubCdn, uploadToPixhost, getFileContentType, uploadToImgBB, uploadToPasteboard, uploadToCatbox, pushName, newsletterUrl } = conText;
